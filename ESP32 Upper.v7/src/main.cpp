  ...
  while (true){
    ...
    if (firstDelimiterIndex > 0){ //コマンド判定
      ...
      if (secondDelimiterIndex > 0) { //数値個数判定
        ...
        if (command == "TB"){ //X
          if (firstValue == 1){
            moveServosToTarget(180,90,170,20,65,stepDelay);
            moveServosToTarget(180,90,150,20,41,stepDelay);
          }
        }
        if (command == "XB"){ //B
          if (firstValue == 1){
        ...
        if (command == "SB"){ //Y
          if (firstValue == 1){
            moveServosToTarget(135,90,150,20,41,stepDelay);
        ...
        if (command == "HB"){ 
          if (firstValue == 1){
            moveServosToTarget(180,180,180,0,90,stepDelay);
          }
        }          
      }
      //ディスプレイ反映
      if (!flag){
        if (command == "redpro" || command == "bluepro" || command == "conpro"){
          ...
          display.clear();
          display.display();
          display.drawString(0,0,"ESP32 Upper.v7");
  ...
  while (true){
    ...
    if (firstDelimiterIndex > 0){ //コマンド判定
      ...
      if (secondDelimiterIndex > 0) { //数値個数判定
        ...
        if (command == "UB"){
          if (firstValue == 1){
            moveServosToTarget1(180,90,170,20,65,stepDelay); //サーボ角度制御
            moveServosToTarget1(180,90,155,20,53,stepDelay); 
          }
        }
        if (command == "DB"){
          if (firstValue == 1){
        ...
        if (command == "LB"){
          if (firstValue == 1){
            moveServosToTarget1(135,90,155,20,53,stepDelay);
        ...
        if (command == "L2A"){
          if (firstValue == 1){
            moveServosToTarget1(180,90,170,20,65,stepDelay);
            moveServosToTarget1(180,90,150,20,43,stepDelay);
            moveServosToTarget1(135,90,150,20,43,stepDelay);
        ...
        if (command == "TAB"){
          if (firstValue == 1){
            moveServosToTarget1(180,0,180,0,90,stepDelay);
          }
        } 
        if (command == "KS"){
          if(firstValue == 1){
